...
sections:
  ...
  - block: "markdown"
    content:
      title: "خوش آمدید"
      text: |
        به آکادمی ققنوس خوش آمدید؛ مکانی برای یادگیری عمیق، پژوهش‌های کاربردی و همکاری‌های بین‌المللی.
        مجموعهٔ ققنوس متشکل از متخصصان و نخبگان ایرانی خارج از کشور است که با هدف ارتقای کیفیت آموزش و تولید محتوای عملی در حوزه‌های هوش مصنوعی، رباتیک و پهپادهای خودران فعالیت می‌کند. ما روی ترکیب آموزش نظری و تجربهٔ میدانی تأکید می‌کنیم تا دانشجویان و پژوهشگران بتوانند مهارت‌های فنی را همراه با روش‌شناسی پژوهش فراگیرند. علاوه بر دوره‌ها و کارگاه‌ها، به نمونه‌سازی سریع، انتشار مقالات و توسعهٔ پروژه‌های متن‌باز می‌پردازیم تا مسیر انتقال دانش به محصولات و خدمات واقعی هموار شود.
        اولویت اصلی ما فراهم کردن منابع به‌روز و دسترسی آسان به آموزش‌های تخصصی برای تمامی اقشار جامعه، به‌ویژه علاقه‌مندان، پژوهشگران و تیم‌های نوپا داخل کشور است. از شما دعوت می‌کنیم مطالب وبلاگ را مرور کرده، در پروژه‌ها مشارکت کنید و اگر علاقه‌مند به همکاری یا ارائهٔ محتوا هستید، با ما در تماس باشید تا بتوانیم مسیر یادگیری و پژوهش را به‌صورت جمعی پیش ببریم.
    design:
      background:
        color: "#ffffff"
    ce: "section-welcome"
